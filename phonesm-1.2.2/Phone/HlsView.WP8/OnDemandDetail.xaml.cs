    ...
    public partial class OnDemandDetail : PhoneApplicationPage
    {
        ...
        void wc_DownloadStringCompletedHandler(object sender, DownloadStringCompletedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Button awayHighlights = new Button { Content = "Away Highlights Not Available", Margin = new Thickness(80, 120, 0, 0), VerticalAlignment = VerticalAlignment.Top, Width = 324, Height = 105 };
                    awayHighlights.HorizontalAlignment = System.Windows.HorizontalAlignment.Left;
                ...
                {
                    Button homeHighlights = new Button { Content = "Home Highlights Not Available", Margin = new Thickness(80, 230, 0, 0), VerticalAlignment = VerticalAlignment.Top, Width = 324, Height = 105 };
                    homeHighlights.HorizontalAlignment = System.Windows.HorizontalAlignment.Left;
                ...
                {
                    Button awayCondensed = new Button { Content = "Away Condensed Not Available", Margin = new Thickness(80, 340, 0, 0), VerticalAlignment = VerticalAlignment.Top, Width = 324, Height = 105 };
                    awayCondensed.HorizontalAlignment = System.Windows.HorizontalAlignment.Left;
                ...
                {
                    Button homeCondensed = new Button { Content = "Home Condensed Not Available", Margin = new Thickness(80, 450, 0, 0), VerticalAlignment = VerticalAlignment.Top, Width = 324, Height = 105 };
                    homeCondensed.HorizontalAlignment = System.Windows.HorizontalAlignment.Left;
